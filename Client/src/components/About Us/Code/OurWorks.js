  ...
  return (
    <div className="OurWorks-conatiner">
      <div className="row">
        ...
        <h2 className="heading-section" style={subheadingStyle}>
          What we do
        </h2>
        <div className="row">
          <div className="col-sm-6 res-s-bttm">
            ...
            <h4 style={subheadingStyle}>Marketing</h4>
            <p style={pStyle}>
          ...
          <div className="col-sm-6">
            ...
            <h4 style={subheadingStyle}>Consultation</h4>
            <p style={pStyle}>
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem
              accusan tiudo lorem quveniamv eniam laud accusan tiud.
            </p>
          ...
          <div className="col-sm-6 res-s-bttm">
            ...
            <h4 style={subheadingStyle}>Accounting</h4>
            <p style={pStyle}>
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem
              accusan tiudo lorem quveniamv eniam laud accusan tiud.
            </p>
          ...
          <div className="col-sm-6">
            ...
            <h4 style={subheadingStyle}>Trademarks</h4>
            <p style={pStyle}>
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem
              accusan tiudo lorem quveniamv eniam laud accusan tiud.
            </p>
