      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-wrap md:text-left text-center order-first">
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              <li>
                <a class="text-gray-600 hover:text-gray-800">Stocks</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Bonds</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Fianance</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Share Market</a>
              </li>
            </nav>
          </div>
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div class="bg-black">
        <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p class="text-sm text-white sm:ml-6 sm:mt-0 mt-4">
            Copyright &copy; {new Date().getFullYear()} - Brokerax
            <a
