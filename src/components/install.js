    ...
    <div className="uk-section ">
      <div className="uk-container">
        <div className="uk-grid uk-flex uk-flex-center">
          <div className="uk-width-5-6@m uk-inline">
            <div className="uk-grid" data-uk-grid="">
              ...
              <div className="uk-width-1-2@m uk-first-column">
                ...
                <div
                  className="uk-grid-small uk-child-width-1-3 uk-child-width-1-4@m uk-margin-medium-top uk-text-center uk-grid"
                  data-uk-grid=""
                >
                  <div className="uk-first-column">
                    ...
                    <p className="uk-text-small">MacOS</p>
                  </div>
                  <div className="uk-first-column">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="uk-text-small">Windows</p>
                  </div>
                  <div className="uk-first-column">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="uk-text-small">Android</p>
                  </div>
                </div>
              </div>
            </div>
